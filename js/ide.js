...
$(document).ready(function () {
  ...
  console.log(
    "Hey, Hammr IDE is open-sourced: https://github.com/VanshajPoonia/hammr. Have fun!"
  );
  ...
  $("body").keydown(function (e) {
    ...
    if (keyCode == 120) {
      ...
      // F8
      e.preventDefault();
      var url = prompt("Enter URL of Hammr API:", apiUrl);
      if (url != null) {
        url = url.trim();
      }
      if (url != null && url != "") {
...
var executableSource =
  '\
Hammr IDE assumes that content of executable is Base64 encoded.\n\
\n\
...
var sqliteSource =
  "\
-- On Hammr IDE your SQL script is run on chinook database (https://www.sqlitetutorial.net/sqlite-sample-database).\n\
-- For more information about how to use SQL with Hammr API please\n\
...
var c3Source =
  '\
// On the Hammr IDE, C3 is automatically\n\
...
var nimSource =
  '\
# On the Hammr IDE, Nim is automatically\n\
...
var bosqueSource =
  '\
// On the Hammr IDE, Bosque (https://github.com/microsoft/BosqueLanguage)\n\
